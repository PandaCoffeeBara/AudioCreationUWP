...
namespace AudioCreation
{
    ...
    public sealed partial class Scenario1_FilePlayback : Page
    {
      ...
      /*      if (fileInput.Duration <= TimeSpan.FromSeconds(0))
            {
            ...
            playVolumeSlider.IsEnabled = true;
        }
        ...
        private void PlayVolumeSlider_ValueChanged(object sender, RangeBaseValueChangedEventArgs e)
        {
            if (fileInput != null)
            {
                fileInput.OutgoingGain = playVolumeSlider.Value;
            }
        }
